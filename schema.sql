...
DROP DATABASE IF EXISTS aloud_local;
CREATE DATABASE aloud_local;
\c aloud_local;
...
insert into collections(id_user_creator, title, description, count_recordings, url_image, created_at) 
values('1', 'pluto scapes', 'pluto  field recordings', '0', 'https://www.nasa.gov/sites/default/files/thumbnails/image/edu_what_is_pluto_1.png', now());
insert into collections(id_user_creator, title, description, count_recordings, url_image, created_at) 
values('1', 'saturn scapes', 'saturn ring vibrations with punk synth', '0', 'https://solarsystem.nasa.gov/system/resources/detail_files/17747_Saturn_and_Titan.jpg', now());
insert into collections(id_user_creator, title, description, count_recordings, url_image, created_at) 
values('1', 'jupiter scapes', 'jupiter storm recordings', '0', 'https://photojournal.jpl.nasa.gov/jpeg/PIA22946.jpg', now());
insert into collections(id_user_creator, title, description, count_recordings, url_image, created_at) 
values('1', 'io sonnets', 'recordings of original Galilean moon sonnets', '0', 'https://upload.wikimedia.org/wikipedia/commons/7/7b/Io_highest_resolution_true_color.jpg', now());
